function speak() {
 ...
 function showHiddenText(){
    document.getElementById("demo").innerHTML= "Welcome to the Loan calculator";
 }
...
function calculate(){
    ...
    var annualinterest= document.getElementById("apr");
    var repayprd= document.getElementById("years");
